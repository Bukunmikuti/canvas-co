...
<template>
    <Dialog>
        <DialogTrigger>
            <div
                class="relative mt-5 transition-all duration-200 cursor-pointer hover:scale-105 hover:shadow-xl"
            ...
            >
                ...
                <div
                    ...
                    class="absolute bottom-0 left-0 bg-black bg-opacity-50 text-white w-full flex flex-col items-start px-3 text-[10px]"
                >
