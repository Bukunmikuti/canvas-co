...
<template>
    <div
        class="w-[var(--sidebar-width)] border-r max-h-[61vh] px-5 flex flex-col justify-around relative"
    >
        <div>
            <!-- profile card -->
            <div
            ...
            >
                <Avatar class="w-[140px] h-[140px] mb-2">
                    <AvatarImage
                        src="https://api.dicebear.com/9.x/avataaars/svg?seed=Andrea"
                        alt="Ifedolapo Durojaiye"
                    />
        ...
        <!-- Logout  -->
        <div class="flex gap-2 text-red-500 cursor-pointer lg:w-full px-5">
            <LogOutIcon />
